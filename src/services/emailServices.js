...
let getBodyHTMLEmail = (dataSend) => {
    ...
    if (dataSend.language === 'en') {
        ...
        <p>You receive this email, you have booked an online appointment on Icare Website</p>
...
let getBodyHTMLEmailRemedy = (dataSend) => {
    ...
    if (dataSend.language === 'vi') {
        result =
            `
        <h3>Xin chào quý khách ${dataSend.patientName}</h3>
        <p>Bạn nhận được Email này thì đã đặt lịch khám bệnh online trên Website Icare thành công</p>
